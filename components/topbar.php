<!------------------------------------------------------------ TOPBAR START------------------------------------------------------------>
<div class="container-fluid fixed-top px-0 wow fadeIn custom-nav" data-wow-delay="0.1s">
    <div class="top-bar text-white-50 row gx-0 align-items-center d-none d-lg-flex">
        <div class="col-lg-6 px-5 text-start">
            <a href="https://www.google.com/maps/place/55+Av.+Ren%C3%A9+Cassin,+69009+Lyon/data=!4m2!3m1!1s0x47f4eb7496a55165:0x14ce65420b6f18e1?sa=X&ved=2ahUKEwj_k9_axvqBAxWYVqQEHRVRDOcQ8gF6BAgPEAA&ved=2ahUKEwj_k9_axvqBAxWYVqQEHRVRDOcQ8gF6BAgVEAI">
                <small><i class="fa fa-map-marker-alt me-2"></i>55 ter Av. René
                    Cassin, 69009 Lyon</small></a>
        ...
        <div class="col-lg-6 px-5 text-end">
            ...
            <a class="text-white-50 ms-3" href="https://www.linkedin.com/company/fly-it-tech/"><i class="fab fa-linkedin-in"></i></a>
            <a class="text-white-50 ms-3" href="https://www.instagram.com/flyittech/"><i class="fab fa-instagram"></i></a>
        </div>
    </div>
    <!------------------------------------------------------------ NAVIGATION ------------------------------------------------------------>
    <?php
